...
pub struct WebRecordingInfo {
    ...
    /// The reason for the recording failure.  This property is available only when the `status` is `failed`.
    #[serde(rename = "failedReason", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "status")]
    pub status: models::WebRecordingStatus,
}

impl WebRecordingInfo {
    /// A recording information model.
    pub fn new(options: models::RecordingOptions, start_time: i64, status: models::WebRecordingStatus) -> WebRecordingInfo {
        WebRecordingInfo {
            duration: None,
            end_time: None,
            failed_reason: None,
