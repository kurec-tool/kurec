...
pub struct WebTimeshiftRecorder {
    ...
    #[serde(rename = "currentRecordId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl WebTimeshiftRecorder {
    ...
    pub fn new(duration: i64, name: String, num_records: i32, pipeline: Vec<models::WebProcessModel>, recording: bool, service: models::MirakurunService) -> WebTimeshiftRecorder {
