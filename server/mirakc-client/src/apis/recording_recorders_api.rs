...
pub async fn get_recorder(
    ...
    program_id: i64,
) -> Result<models::WebRecordingRecorder, Error<GetRecorderError>> {
...
pub async fn get_recorders(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::WebRecordingRecorder>, Error<GetRecordersError>> {
...
) -> Result<(), Error<StartRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stop_recording(
    configuration: &configuration::Configuration,
    program_id: i64,
) -> Result<(), Error<StopRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_program_id = program_id;
