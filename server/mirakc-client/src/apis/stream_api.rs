...
pub async fn check_channel_stream(configuration: &configuration::Configuration, r#type: models::ChannelType, channel: &str, x_mirakurun_priority: Option<i32>, decode: Option<bool>, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<CheckChannelStreamError>> {
...
pub async fn check_program_stream(configuration: &configuration::Configuration, id: i64, x_mirakurun_priority: Option<i32>, decode: Option<bool>, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<CheckProgramStreamError>> {
    ...
    let uri_str = format!("{}/programs/{id}/stream", configuration.base_path, id=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::HEAD, &uri_str);
...
pub async fn check_record_stream(configuration: &configuration::Configuration, id: &str, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<CheckRecordStreamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_pre_filters = pre_filters;
    let p_post_filters = post_filters;

    let uri_str = format!("{}/recording/records/{id}/stream", configuration.base_path, id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::HEAD, &uri_str);
...
pub async fn get_channel_stream(configuration: &configuration::Configuration, r#type: models::ChannelType, channel: &str, x_mirakurun_priority: Option<i32>, decode: Option<bool>, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<GetChannelStreamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_channel = channel;
    let p_x_mirakurun_priority = x_mirakurun_priority;
...
pub async fn get_record_stream(configuration: &configuration::Configuration, id: &str, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<GetRecordStreamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_pre_filters = pre_filters;
    let p_post_filters = post_filters;
...
pub async fn get_service_stream_by_channel(configuration: &configuration::Configuration, r#type: models::ChannelType, channel: &str, sid: i32, x_mirakurun_priority: Option<i32>, decode: Option<bool>, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<GetServiceStreamByChannelError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_channel = channel;
    let p_sid = sid;
...
pub async fn head(configuration: &configuration::Configuration, r#type: models::ChannelType, channel: &str, sid: i32, x_mirakurun_priority: Option<i32>, decode: Option<bool>, pre_filters: Option<Vec<String>>, post_filters: Option<Vec<String>>) -> Result<(), Error<HeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_channel = channel;
    let p_sid = sid;
