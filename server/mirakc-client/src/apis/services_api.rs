...
pub async fn get_logo_image(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<(), Error<GetLogoImageError>> {
...
pub async fn get_programs_of_service(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<Vec<models::MirakurunProgram>, Error<GetProgramsOfServiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_service(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<models::MirakurunService, Error<GetServiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_services(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::MirakurunService>, Error<GetServicesError>> {
